...
function ConstraintFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" data-testid="constraint-form-modal">
      <div className="w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
        ...
        <div className="mt-4 space-y-4">
          <div>
            <label htmlFor="constraint-id" className="block text-sm font-medium text-gray-700">
              Constraint ID
            </label>
            <input
              id="constraint-id"
          ...
          <div>
            <label htmlFor="constraint-description" className="block text-sm font-medium text-gray-700">
              Description
            </label>
            <input
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="constraint-severity" className="block text-sm font-medium text-gray-700">
                Severity
              </label>
              <select
            ...
            <div>
              <label htmlFor="constraint-category" className="block text-sm font-medium text-gray-700">
                Category
              </label>
              <select
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="constraint-owner" className="block text-sm font-medium text-gray-700">
                Owner
              </label>
              <input
                id="constraint-owner"
            ...
            {showStatus && (
              <div>
                <label htmlFor="constraint-status" className="block text-sm font-medium text-gray-700">
                  Status
                </label>
                <select
          ...
          <div>
            <label htmlFor="constraint-xml" className="block text-sm font-medium text-gray-700">
              XML Block
            </label>
            <textarea
              id="constraint-xml"
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="sm:flex sm:items-center sm:justify-between">
          <div>
            <div className="flex items-center gap-4">
              <h1 className="text-2xl font-bold text-gray-900">Constraint Library</h1>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
          ...
          <select
            ...
            className="rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none"
          >
                  ...
                  {filteredConstraints.map((constraint) => (
                    <tr key={constraint.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        <div className="text-sm text-gray-900">{constraint.description}</div>
                        <div className="mt-1 text-xs text-gray-500">{constraint.owner}</div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
